...
function App() {
  ...
  useEffect(() => {
    ...
    landingAudioRef.current = new Audio(`${import.meta.env.BASE_URL}audio/landing.mp3`);
    landingAudioRef.current.loop = true;
    quizAudioRef.current = new Audio(`${import.meta.env.BASE_URL}audio/quiz.mp3`);
    quizAudioRef.current.loop = true;
    spriteAudioRef.current = new Audio(`${import.meta.env.BASE_URL}audio/sprite.mp3`);
    spriteAudioRef.current.loop = true;
    birthdayAudioRef.current = new Audio(`${import.meta.env.BASE_URL}audio/birthday.mp3`);
